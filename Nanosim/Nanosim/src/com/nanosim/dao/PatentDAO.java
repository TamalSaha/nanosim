...
public class PatentDAO {
	...
	/***************************************************************************
	Method to access patents table
	***************************************************************************/
	
	//Gets all group's patents
	public List<Patent> getGroupPatents(long groupId) {
		...
		try {
			...
			while (rs.next()) {
				...
				String s = sdf.format(rs.getTimestamp("submitted")); 
				p.setSubmitted(s);
	...
	/***************************************************************************
	Method to modify patents table
	***************************************************************************/
