...
public class PatentHome extends StackContentBase {
	...
	private PatentGroupList groupPatentList;
	private PatentApprovedList approvedList;
	private PatentNewList newPatentList;
	...
	public void loadShortcuts(CenterPanel centerPanel) {
		...
		this.groupPatentList = new PatentGroupList();
		this.approvedList = new PatentApprovedList();
		this.newPatentList = new PatentNewList();
	...
	public void onSelection(SelectionEvent<TreeItem> event) {
		...
		} else if (title.equals("New Submissions")) {
			centerPanel.clear();
