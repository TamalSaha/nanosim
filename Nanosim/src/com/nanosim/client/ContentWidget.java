...
public abstract class ContentWidget extends LazyPanel implements
	...
	/**
	 * A boolean indicating whether or not the RPC request for the source code
	 * has been sent.
	 */
	...
	public void onSelection(SelectionEvent<Integer> event) {
		...
		if (!sourceLoaded && tabHTML.equals(constants.contentWidgetSource())) {
			...
			requestSourceContents(NanosimConstants.DST_SOURCE_EXAMPLE
	 ...
	 * 
	 * @param url
	 *            a partial path relative to the module base URL
	 * @param target
	 *            the target Widget to place the contents
	 * @param callback
