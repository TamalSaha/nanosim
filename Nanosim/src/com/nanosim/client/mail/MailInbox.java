...
//					formatted = fmt.format(item.getSent());
	...
	public void setItem(Mail item) {
		/*		subject.setHTML("<b>Subject:</b>&nbsp;" + item.getSubject());
		sender.setHTML("<b>From:</b>&nbsp;" + item.getFromGroupName());
		recipient.setHTML("<b>To:</b>&nbsp;" + item.getToGroupName());
		//date.setHTML("<b>Sent:</b>&nbsp;" + item.date);
		body.setHTML("<br>" + item.getMessage());*/
